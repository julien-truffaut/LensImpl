...
import lensimpl.LensCC
import org.openjdk.jmh.annotations.{Benchmark, Scope, State}

@State(Scope.Benchmark)
class LensCCBench {

  val n1 = LensCC[Nested0, Nested1](_.n, (n2, n1) => n1.copy(n = n2))
  val n2 = LensCC[Nested1, Nested2](_.n, (n3, n2) => n2.copy(n = n3))
  val n3 = LensCC[Nested2, Nested3](_.n, (n4, n3) => n3.copy(n = n4))
  val n4 = LensCC[Nested3, Nested4](_.n, (n5, n4) => n4.copy(n = n5))
  val n5 = LensCC[Nested4, Nested5](_.n, (n6, n5) => n5.copy(n = n6))
  val n6 = LensCC[Nested5, Nested6](_.n, (n7, n6) => n6.copy(n = n7))

  val n0_i = LensCC[Nested0, Int](_.i, (i, n) => n.copy(i = i))
  val n3_i = LensCC[Nested3, Int](_.i, (i, n) => n.copy(i = i))
  val n6_i = LensCC[Nested6, Int](_.i, (i, n) => n.copy(i = i))
